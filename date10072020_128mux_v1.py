# 128 mux resonator - main function 
# Nicole Farias, September 2020
...
def main():
    print("\nWelcome to the resonator chip maker! \nThis code is adapted from the C code for the 40mux PPC chip.")
    print("Note: default length unit is microns")
    # import parameters
    directory = 'C:/Users/nicol/Documents/00Research/L-Edit/Resonator Project/128 mux/October 07 2020 - Aligned Checkerboard v1 and v2 fix pads/'
    filename = 'Parameters_128mux_chip4_v1.txt'
